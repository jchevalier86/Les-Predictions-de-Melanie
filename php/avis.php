<?php
    ...
    $avis_clients_email = $_SESSION['user_email']; // Utiliser l'e-mail depuis la session

    // Vérification que tous les champs de formulaire nécessaires sont définis
    if (isset($_POST['rating'], $_POST['nom'], $_POST['prenom'], $_POST['avis'])) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->addAddress($_ENV['SMTP_USER'], 'Les Prédictions de Mélanie');
